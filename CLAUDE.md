...
|---|---|
| `app/` | App Router pages. `page.tsx` is the registry, `agent/[id]` is a shareable passport |
| `components/` | `RegistryApp` is the interactive site, `PassportView` is the passport body shared by modal and page |
